...
<div >
  ...
  <div className="mt-3 mb-2">
    ...
    <div className="card-actions justify-between">
      <div className="btn w-20 p-3 border-0 text-xl text-green-400"><span><MdOutlineFileDownload /></span> {million } <span className="text-xl font-normal">M</span></div>
